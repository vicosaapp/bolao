...
$page_title = "Teste - Dashboard do Gestor";

// Verificar permissões
require_once '../auth.php';
requireAccess(2); // Nível mínimo: gestor
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">Página de Teste - Gestor</h5>
                </div>
                <div class="card-body">
                    <p>Se você está vendo esta mensagem, o painel de gestor está funcionando corretamente!</p>
