...
$page_title = "Teste - Dashboard do Apostador";

// Verificar permissões
require_once '../auth.php';
requireAccess(1); // Nível mínimo: apostador
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">Página de Teste - Apostador</h5>
                </div>
                <div class="card-body">
                    <p>Se você está vendo esta mensagem, o painel de apostador está funcionando corretamente!</p>
